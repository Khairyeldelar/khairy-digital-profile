...
describe("ArticlePreviewDialog", () => {
  it("renders the unsaved title, summary, rich text, and links before publishing", () => {
    render(<ArticlePreviewDialog open onOpenChange={() => {}} category="tutorials" title="شرح كامل" summary="ملخص المقال" body={'<h2>خطوة أولى</h2><p>نص <strong>منسق</strong></p><p><a href="https://example.com">رابط</a></p>'} />);
